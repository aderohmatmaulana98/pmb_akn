            ...
            <div class="card p-5" id="biodata">
                <form action="<?= base_url('user/aksi_tambah_formulir') ?>" method="POST" enctype="multipart/form-data">
                    <div class=" mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= $detail_form['nama_lengkap']; ?>" readonly required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?= $detail_form['tempat_lahir']; ?>" readonly required>
                            </div>
                            <div class="col-lg-6">
                                <input type="date" class="form-control" id="tgl_lahir" value="<?= $detail_form['tanggal_lahir']; ?>" name="tgl_lahir" readonly required>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="provinsi_tempat_lahir" name="provinsi_tempat_lahir" disabled required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="no_hp" name="no_hp" value="<?= $detail_form['telepon'] ?>" readonly required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap" cols="30" rows="10" readonly required><?= $detail_form['alamat']; ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kode_pos" name="kode_pos" value="<?= $detail_form['kode_pos'] ?>" readonly required>
                    </div>
                    <div class="mb-3">
                        <label for="kewarganegaraan" class="form-label">Kewarganegaraan</label>
                        <input type="text" class="form-control" id="kewarganegaraan" value="<?= $detail_form['kewarganegaraan'] ?>" name="kewarganegaraan" readonly required>
                    </div>
                    <div class="mb-3">
            ...
            <div class="card visually-hidden p-5" id="data_sekolah">
                <form action="<?= base_url('user/aksi_tambah_sekolah_asal'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="provinsi_asal_sekolah" class="form-select" id="provinsi_asal_sekolah" disabled required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_lengkap_sekolah" class="form-control" id="alamat_lengkap_sekolah" cols="30" rows="10" readonly required><?= $detail_sekolah['alamat_lengkap_sekolah']; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Jurusan</label>
                        <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?= $detail_sekolah['jurusan']; ?>" readonly required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="tahun_lulus" value="<?= $detail_sekolah['tahun_lulus']; ?>" name="tahun_lulus" readonly required>
                    </div>
                    <div class="mb-3">
                        <label for="no_ijazah" class="form-label">No Ijazah</label>
                        <input type="text" class="form-control" id="no_ijazah" name="no_ijazah" value="<?= $detail_sekolah['no_ijazah']; ?>" readonly required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_indonesia" name="bhs_indonesia" value="<?= $detail_sekolah['bhs_indonesia']; ?>" readonly required>
                            </div>
                            <div class="col-lg-4">
                                <label for="bhs_inggris" class="form-label">Bhs Inggris</label>
                                <input type="text" class="form-control" id="bhs_inggris" name="bhs_inggris" value="<?= $detail_sekolah['bhs_inggris']; ?>" readonly required>
                            </div>
                            <div class="col-lg-4">
                                <label for="matematika" class="form-label">Matematika</label>
                                <input type="text" class="form-control" id="matematika" name="matematika" value="<?= $detail_sekolah['matematika']; ?>" readonly required>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="card p-5 visually-hidden" id="data_ortu">
                <form action="<?= base_url('user/aksi_tambah_data_ortu') ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_ayah" name="nama_ayah" value="<?= $data_ortu['nama_ayah']; ?>" readonly required>
                    </div>
                    <div class="mb-3">
                        <label for="pendidikan_terakhir_ayah" class="form-label">Pendidikan Terakhir Ayah</label>
                        <select class="form-select" name="pendidikan_terakhir_ayah" id="pendidikan_terakhir_ayah" disabled required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah" value="<?= $data_ortu['pekerjaan_ayah']; ?>" readonly required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" readonly value="<?= $data_ortu['nama_ibu'] ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu" value="<?= $data_ortu['pekerjaan_ibu']; ?>" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_lengkap_ortu" class="form-control" id="alamat_lengkap_ortu" cols="30" rows="10" required readonly><?= $data_ortu['alamat_lengkap_ortu']; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="provinsi_asal_orang_tua" class="form-label">Provinsi Asal Orang Tua</label>
                        <select name="provinsi_asal_orang_tua" class="form-control" id="provinsi_asal_orang_tua" disabled required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="kabupaten_asal_orang_tua" class="form-control" id="kabupaten_asal_orang_tua" disabled required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kodepos_alamat_orang_tua" name="kodepos_alamat_orang_tua" readonly value="<?= $data_ortu['kode_pos_ortu'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="no_telp_orang_tua" class="form-label">No Telp Orang Tua</label>
                        <input type="text" class="form-control" id="no_telp_orang_tua" name="no_telp_orang_tua" value="<?= $data_ortu['telepon_ortu'] ?>" readonly required>
                    </div>
                    <div class="mb-3">
                        <label for="nama_wali" class="form-label">Nama Wali (Jika Ada)</label>
                        <input type="text" class="form-control" id="nama_wali" name="nama_wali" value="<?= $data_ortu['nama_wali'] ?>" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="pekerjaan_wali" class="form-label">Pekerjaan Wali</label>
                        <input type="text" class="form-control" id="pekerjaan_wali" name="pekerjaan_wali" value="<?= $data_ortu['pekerjaan_wali'] ?>" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="alamat_lengkap_wali" class="form-label">Alamat Lengkap Wali</label>
                        <textarea name="alamat_lengkap_wali" class="form-control" id="alamat_lengkap_wali" cols="30" rows="10" readonly><?= $data_ortu['alamat_lengkap_wali'] ?></textarea>
                    </div>
                </form>
            </div>
